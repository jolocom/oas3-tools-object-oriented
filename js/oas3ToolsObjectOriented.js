...
const oas3ToolsObjectOriented = (controllers, configuration) => {
    ...
    const oas3AppConfig = oas3Tools.expressAppConfig(configuration.oas3DeclarationFilePath, { routing: { controllers: oas3ToControllerMethodMap }, ...configuration.oas3AppOptions });
